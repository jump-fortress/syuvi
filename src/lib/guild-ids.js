...
if (process.env.FLY_APP_NAME === "syuvi") {
  ...
  divisionRoleIds = new Map([
    ...
    ["Steel Soldier", "1422300966362939493"],
    ["Wood Soldier", "1364256052844957727"],
    ["Diamond Demo", "1322534308510040093"],
    ["Platinum Demo", "1322534308510040091"],
    ["Gold Demo", "1322534308510040089"],
    ["Silver Demo", "1322534308510040087"],
    ["Bronze Demo", "1322534308510040085"],
    ["Steel Demo", "1422308983347347466"],
  ...
  timesChannelIds = new Map([
    ["Diamond", "1322534310720438286"],
    ["Platinum", "1322534310720438287"],
    ["Gold", "1322534310720438288"],
    ["Silver", "1322534310720438289"],
    ["Bronze", "1322534310720438290"],
    ["Steel", "1422300082950111374"],
  ...
  divisionRoleIds = new Map([
    ...
    ["Diamond Demo", "1456007240032194571"],
